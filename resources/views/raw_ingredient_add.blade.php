            ...
            <div class="col-md">
                <form action="/raw-ingredients/add-new" method="POST" class="login-form" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control p-3 @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" autofocus>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control p-3 @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code') }}" placeholder="misal: RAW001">
                        @error('code')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>    
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select p-3 @error('unit') is-invalid @enderror" aria-label="Default select example" id="unit" name="unit">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control p-3 @error('stock') is-invalid @enderror" id="stock" name="stock" value="{{ old('stock') }}" placeholder="contoh: 4.4 (pakai titik)">
                        @error('stock')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>    
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control p-3 @error('minimum_stock') is-invalid @enderror" id="minimum_stock" name="minimum_stock" value="{{ old('minimum_stock') }}" placeholder="contoh: 4.4 (pakai titik)">
                        @error('minimum_stock')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>    

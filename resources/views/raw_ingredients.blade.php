                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if ($rawIngredient->image)
                                        <img class="rounded-circle mx-auto" src="{{ asset('storage/img/' . $rawIngredient->image) }}" alt="Gambar Bahan Mentah" width="36" height="36" onclick="window.open('{{ asset('storage/img/' . $rawIngredient->image) }}')">
                                    @else

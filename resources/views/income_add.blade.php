            ...
            <div class="col-md-6 order-2 order-md-1">
                ...
                <form action="/incomes/add-new" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control p-3 @error('amounts') is-invalid @enderror" id="amounts" name="amounts" value="{{ old('amounts') }}" placeholder="contoh: 1,2,3" required>
                        @error('amounts')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>    
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control p-3 @error('prices') is-invalid @enderror" id="prices" name="prices" value="{{ old('prices') }}" placeholder="contoh: 10000,15000,20000" autofocus required>
                        @error('prices')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>    
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control p-3 @error('total_price') is-invalid @enderror" placeholder="contoh: 45000" aria-label="total_price" aria-describedby="basic-addon1" id="total_price" name="total_price" value="{{ old('total_price') }}">
                            @error('total_price')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>    

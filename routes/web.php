 ...
 */
Route::get('/raw-ingredients', [RawIngredientController::class, 'index'])->middleware(IsLoggedIn::class);
Route::get('/raw-ingredients/add-new', [RawIngredientController::class, 'create'])->middleware(IsLoggedIn::class);
Route::post('/raw-ingredients/add-new', [RawIngredientController::class, 'store'])->middleware(IsLoggedIn::class);
Route::patch('/raw-ingredients/deactivate/{code}', [RawIngredientController::class, 'deactivate'])->middleware(IsLoggedIn::class);
Route::patch('/raw-ingredients/activate/{code}', [RawIngredientController::class, 'activate'])->middleware(IsLoggedIn::class);
Route::get('/raw-ingredients/{code}/edit', [RawIngredientController::class, 'edit'])->middleware(IsLoggedIn::class);
Route::patch('/raw-ingredients/{code}/edit', [RawIngredientController::class, 'update'])->middleware(IsLoggedIn::class);
Route::delete('/raw-ingredients/{code}/delete', [RawIngredientController::class, 'destroy'])->middleware(IsLoggedIn::class);
